...
public class ProductDao extends Dao {
    ...
    public boolean getPlikeWrite( int pno , int mno ){  System.out.println("pno = " + pno + ", mno = " + mno);
        try {
    ...
    public boolean getPlikeView( int pno , int mno ){   System.out.println("pno = " + pno + ", mno = " + mno);
        try {
